    ...
    public class LensFlareComponent : DrawableGameComponent
    {
        ...
        public void UpdateOcclusion()
        {
            ...
            if (occlusionQueryActive)
            {
                ...
                // On mobile platforms, we can't use occlusion queries,
                // so just assume the sun is always visible
                // TODO ___MOBILE___ occlusionAlpha = 1.0f;
            }
            ...
            // On mobile platforms, render the query geometry without occlusion testing
            /* TODO GraphicsDevice.DrawUserPrimitives(PrimitiveType.TriangleStrip, queryVertices, 0, 2);
            occlusionQueryActive = true; */
