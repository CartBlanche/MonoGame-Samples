...
namespace HoneycombRush
{
    ...
    public class GameplayScreen : GameScreen
    {
        ...
        public GameplayScreen(DifficultyMode gameDifficultyMode)
        {
            ...
            using (var stream = TitleContainer.OpenStream("Content/Configuration/Configuration.xml"))
            {
                doc = XDocument.Load(stream);
            }
			
            ConfigurationManager.LoadConfiguration(doc);
        ...
        private void LoadAnimationFromXML()
        {
            ...
            using (var stream = TitleContainer.OpenStream("Content/Textures/AnimationsDefinition.xml"))
            {
                doc = XDocument.Load(stream);
            }
