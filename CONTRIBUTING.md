# Contributing to MonoGame-Samples
...
If you are looking for ways to help, you should start by looking at the [Help Wanted tasks](https://github.com/CartBlanche/MonoGame-Samples/issues?q=is%3Aissue+is%3Aopen+label%3A%22Help+Wanted%22).  Please let us know if you plan to work on an issue so that others are not duplicating your work.
...
The MonoGame-Samples project follows standard [GitHub flow](https://guides.github.com/introduction/flow/index.html).  You should learn and be familiar with how to [use Git](https://help.github.com/articles/set-up-git/), how to [create a fork of MonoGame-Samples](https://help.github.com/articles/fork-a-repo/), and how to [submit a Pull Request](https://help.github.com/articles/using-pull-requests/).

After you submit a PR, the [MonoGame-Samples CI](https://github.com/CartBlanche/MonoGame-Samples/actions) will build your changes and verify that all tests pass.  Project maintainers and contributors will review your changes and provide constructive feedback to improve your submission.
...
* **PLEASE** tell others about MonoGame-Samples and your contributions via social media.
...
The MonoGame-Samples project is under the MIT except for a few portions of the code.  See the [LICENSE](LICENSE.md) file for more details.  Third-party libraries used by MonoGame-Samples are under their own licenses.  Please refer to those libraries for details on the licenses they use.
...
If you need help, please ask questions on our [GitHub Discussion board](https://github.com/CartBlanche/MonoGame/discussions) or come [chat on Discord](https://discord.gg/monogame).
