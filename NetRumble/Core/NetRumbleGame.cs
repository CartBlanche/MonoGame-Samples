...
namespace NetRumble
{
    ...
    public class NetRumbleGame : Microsoft.Xna.Framework.Game
    {
        ...
        public NetRumbleGame()
        {
            ...
            var audioPath = Path.Combine(AppDomain.CurrentDomain.BaseDirectory, Content.RootDirectory, "Audio", "wav");
            AudioManager.Initialize(this, new DirectoryInfo(audioPath));
        }
        ...
        void NetworkSession_InviteAccepted(object sender, InviteAcceptedEventArgs e)
        {
            ...
            {
                screenManager.invited = e.Gamer as SignedInGamer;
