    ...
    class SessionBrowserScreen : MenuScreen
    {
        ...
        void HostGameMenuEntrySelected(object sender, EventArgs e)
        {
            ...
            busyScreen.OperationCompleted += (s, evt) =>
            {
                ...
                {
                    ScreenManager.AddScreen(new MessageBoxScreen(Resources.FailedToCreateSession, Resources.OK), null);
                }
            };
        ...
        void JoinSessionMenuEntrySelected(object sender, EventArgs e)
        {
            ...
            if (availableSession != null)
            {
                ...
                busyScreen.OperationCompleted += (s, evt) =>
                {
                    ...
                    {
                        ScreenManager.AddScreen(new MessageBoxScreen(Resources.FailedToJoinSession, Resources.OK), null);
                    }
                };
                ScreenManager.AddScreen(busyScreen, null);
            }
        ...
        public override void HandleInput(InputState inputState)
        {
            ...
            else if (UIUtility.IsMobile)
            {
                ...
                if (inputState.Gestures.Count > 0 && inputState.Gestures[0].GestureType == GestureType.Tap)
                {
                    isClicked = true;
