...
namespace CatapultGame
{
    ...
    class ProfileSignInScreen : GameScreen
    {
                                                       ...
                                                       bool coveredByOtherScreen)
        {
            ...
            else if (IsActive && !Guide.IsVisible)
            {
                ...
                if ((Guide.IsTrialMode) &&
                    ...
                    (Gamer.SignedInGamers[ControllingPlayer.HasValue ? (int)ControllingPlayer.Value : (int)PlayerIndex.One] != null) &&
        ...
        bool ValidProfileSignedIn()
        {
            ...
            SignedInGamer gamer = Gamer.SignedInGamers[ControllingPlayer.HasValue ? (int)ControllingPlayer.Value : (int)PlayerIndex.One];
