...
- `Platforms/Windows/` — Windows-specific project (net10.0-windows)
- `Platforms/DesktopGL/` — DesktopGL cross-platform project (net10.0)
- `Platforms/Android/` — Android project (net10.0-android)
- `Platforms/iOS/` — iOS project (net10.0-ios)
